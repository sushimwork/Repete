          ...
          <div className={`pg ${page === 'wardrobe' ? 'act' : ''}`}>
            ...
            <div className="wg">
              ...
              {!atWardrobeLimit
                ...
                : : <div className="locked-tile" onClick={() => setShowUpgrade(true)}><svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg><span>Upgrade to add more</span></div>
              }
            </div>
          </div>
